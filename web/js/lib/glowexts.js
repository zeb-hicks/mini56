...
GLOW.Box2D = (function() {
    ...
    box2D.prototype.top = function(value) {
        if (value !== undefined && typeof value === 'number') {
            var td = (this.y - this.ry) - value;
            this.y -= td / 2;
            this.ry += td;
        }
    ...
    box2D.prototype.bottom = function(value) {
        if (value !== undefined && typeof value === 'number') {
            var td = (this.y - this.ry) - value;
            this.y += td / 2;
            this.ry += td;
    ...
    box2D.prototype.left = function(value) {
        if (value !== undefined && typeof value === 'number') {
            var td = (this.x - this.rx) - value;
            this.x -= td / 2;
            this.rx += td;
        }
    ...
    box2D.prototype.right = function(value) {
        if (value !== undefined && typeof value === 'number') {
            var td = (this.x - this.rx) - value;
            this.x += td / 2;
            this.rx += td;
...
GLOW.Camera = function( parameters ) {
    ...
    this.aspect = parameters.aspect !== undefined ? parameters.aspect : self.innerWidth / self.innerHeight;
